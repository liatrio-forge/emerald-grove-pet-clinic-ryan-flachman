...
| 14 | [visit-summary-parser](14-spec-visit-summary-parser/) | accepted | Parse Claude JSON response into VisitSummary; VisitSummaryParseException for malformed input |
