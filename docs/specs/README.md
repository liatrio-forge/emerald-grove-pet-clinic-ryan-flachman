...
| 19 | [health-timeline-fragment](19-spec-health-timeline-fragment/) | delivered | Thymeleaf fragment rendering per-pet AI visit health timeline with spinner, error, and done states |
